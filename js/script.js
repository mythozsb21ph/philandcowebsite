...
// Form submission
// Note: This blocks the default submission for simulation.
// Applicant form uses external mail forwarding (formsubmit.co), so we only
// apply this handler to forms that are NOT the applicant application form.
const form = document.querySelector('form');
if (form) {
    const isApplicantForm = form.classList && form.classList.contains('applicant-form');
